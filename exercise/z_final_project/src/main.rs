...
fn main() {
    ...
    match subcommand.as_str() {
        ...
        "blur" => {
            ...
            let blur_amount = args.remove(0).parse::<f32>().unwrap();
            // **OPTION**
        ...
        "brighten" => {
            ...
            let infile = args.remove(0);
            let outfile = args.remove(0);
            let brighten_amount = args.remove(0).parse::<i32>().unwrap();
            // **OPTION**
            // Improve the blur implementation -- see the blur() function below
        ...
        "crop" => {
            ...
            // **OPTION**
            // Improve the blur implementation -- see the blur() function below
            crop(infile, outfile, x, y, height, width);
        }
        ...
        "rotate" => {
            ...
            let infile = args.remove(0);
            let outfile = args.remove(0);
            let degree = args.remove(0).parse::<i32>().unwrap();
...
fn rotate(infile: String, outfile: String, degree: i32) {
    // See blur() for an example of how to open an image.
